...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("2349035391852")
...
global.sudo = process.env.SUDO || '2349035391852'
global.devs = '923096566451';
global.website = 'https://github.com/vajirabot1/KING-VAJIRA-MD' // Hello world
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/a833c4b7a894752a21779.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'TROUBLEMAKER😉' : process.env.BOT_NAME,TROUBLEMAKER😉
  ownername: process.env.OWNER_NAME === undefined ? 'The Honored One' : process.env.OWNER_NAME,
